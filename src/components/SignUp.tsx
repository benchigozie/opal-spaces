    ...
    <div className="w-full">
      <form action="" className="flex flex-col gap-3 w-full">
        <div className="flex flex-col gap-1">
          ...
          <input type="text" id="first-name" className="rounded-full shadow-sm py-2 px-4 outline-light-wood/20 focus:outline-light-wood outline-1 caret-light-wood text-my-brown" />
        </div>
        <div className="flex flex-col gap-1">
          <label htmlFor="last-name" className="text-my-brown">Last Name</label>
          <input type="text" id="last-name" className="rounded-full shadow-sm py-2 px-4 outline-light-wood/20 focus:outline-light-wood outline-1 caret-light-wood text-my-brown" />
        </div>
        <div className="flex flex-col gap-1">
        ...
        <div className="flex flex-col gap-1">
          ...
          <input type="password" id="confirm-password" className="rounded-full shadow-sm py-2 px-4 outline-light-wood/20 focus:outline-light-wood outline-1 caret-light-wood text-my-brown" />
        </div>
