...
function ShopHero() {
  return (
    <section
      ...
      <div className="flex flex-col items-center justify-center max-w-[800px] gap-6 z-10 bg-my-brown/30 px-10 md:px-16 py-24 rounded-2xl outline-my-white/50 outline-1">
        <motion.h1
